...
#########################################################
def prepare_Kaggle_dataset(base_path):
    training_data_path = os.path.join(base_path, "fer2013.csv")
    read_data = np.loadtxt(open(training_data_path, "rb"), delimiter=",", skiprows=1)
